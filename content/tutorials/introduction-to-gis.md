...
![QGIS application open with a new, empty project and no layers added yet](/images/tutorials/Screenshot-2025-12-12-164531.png)
...
![QGIS showing an untitled new project with an empty map canvas and the toolbar ready for adding layers](/images/tutorials/Screenshot-2025-12-12-164540.png)
...
![QGIS map canvas showing a world basemap added from OpenStreetMap XYZ tiles](/images/tutorials/Screenshot-2025-12-12-164546.png)

Zoom in with your mouse to Venice, Italy.  

### 4. Upload Georeferenced Map as a Layer

  * Go to the google drive to [download the map](https://drive.google.com/file/d/13amfIIESg6P72Jb5zWL2Nb3PNLVObwNo/view?usp=sharing).
...
QGIS has a [tutorial on digitizing polygons](https://docs.qgis.org/3.34/en/docs/training_manual/create_vector_data/create_new_vector.html#try-yourself-digitizing-polygons) which this has been adapted from.
...
![QGIS Vertex Tool tooltip displayed over a zoomed-in historic map of Venice, listing keyboard and mouse shortcuts for selecting vertices](/images/tutorials/Screenshot-2025-12-12-162435-e1765575181787.png)
...
![QGIS canvas showing shapefile vertices highlighted in red over a historic map of Venice, with the San Marco Churches, Canals, and Bridges layers listed in the panel](/images/tutorials/Screenshot-2025-12-12-162516-e1765575416141.png)
...
![Diagram showing a single 'Base Map' layer as the bottom layer in a stack](/images/tutorials/Screenshot-2025-12-12-163958.png)
...
![Diagram showing a 'Historic Map' layer stacked on top of the 'Base Map' layer](/images/tutorials/Screenshot-2025-12-12-164027.png)
...
![Diagram showing a blank new shapefile layer stacked above the Historic Map and Base Map layers](/images/tutorials/Screenshot-2025-12-12-164047.png)
...
![Diagram showing a single-polygon shapefile layer with one shape, stacked above the Historic Map and Base Map layers](/images/tutorials/Screenshot-2025-12-12-164108.png)
...
![Diagram showing four separate single-polygon shapefile layers, one per building, stacked above the Historic Map and Base Map layers](/images/tutorials/Screenshot-2025-12-12-164128.png)

### 2) Multi Line/Point or Polygon Shapefile

The same few steps apply to a multipolygon shapefile:

![Diagram showing a new shapefile layer containing multiple shapes, stacked above the Historic Map and Base Map layers](/images/tutorials/Screenshot-2025-12-12-164311.png)
...
![Diagram showing four multipolygon shapefile layers—Parks, Government Buildings, Churches, and Houses—each containing multiple shapes, stacked above the Historic Map and Base Map layers](/images/tutorials/Screenshot-2025-12-12-164323.png)
